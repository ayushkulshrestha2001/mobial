...
class CustomDuty extends StatefulWidget {
  CustomDuty({Key? key}) : super(key: key);

  @override
  _CustomDutyState createState() => _CustomDutyState();
}

class _CustomDutyState extends State<CustomDuty> {
  ...
  handleCamera(BuildContext context) async {
    ...
    var bUrl = Uri.parse("https://mobial.azurewebsites.net/api/scan_cduty");
  ...
  getList() async {
    ...
    var url = Uri.parse("https://mobial.azurewebsites.net/api/get_cduty");
